 ...
 ******************************************************************************/
U32 GetAllKings(PersonID *kings)
{
    U8 c,i,count;
    U32 b;
            ...
            switch (Msg.param)
            {
                ...
                default:
                    if (Msg.param >= VK_DIGIT0 && Msg.param <= VK_DIGIT0 + 9) {
                        U8 digit = (U8)(Msg.param - VK_DIGIT0);
                        U32 pow10 = 1;
                        U32 curDigit;
                        U32 next;
                        U8 pi;
                        ...
                        curDigit = (donum / pow10) % 10;
                        next = donum - curDigit * pow10 + ((U32)digit) * pow10;
