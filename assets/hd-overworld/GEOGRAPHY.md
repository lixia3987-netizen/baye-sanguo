...
1080p 画布只是**摄像机窗口**。
开局对准西凉–襄平–建业–成都一带，不把全国塞进一屏。拖动平移，**硬夹在可玩矩形内**，没有惯性越界。

## 摄像机夹紧

可玩矩形（地图空间）=`fit.playableBounds`，当前 `[0, 0, 3840, 4000]`，与底图像素一致（含南海垫高，不当成空白）。
...
拖动中 / 松手 / 改 scale 后都再夹一次。视口只从底图取样，四边顶死不再露出画布底色。
