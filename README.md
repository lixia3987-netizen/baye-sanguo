...
真·HD 大地图（1080p 现代 2D 策略图、城/地形/路/字/反馈分层、经典 LCD 可切回）的锁定规格见 [docs/hd-overworld-spec.md](docs/hd-overworld-spec.md)。当前仓库**还没有**这张地图的成品美术；用户投放素材前只按该文档的清单与分期做，不替换 `dat.lib`。
